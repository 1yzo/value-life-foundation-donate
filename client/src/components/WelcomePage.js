  ...
  <div className="page page--first welcome" style={backgroundStyle}>
    ...
    >
      <h1 className="page__content__header">
        Welcome to <br /> Value Life Foundation
      </h1>
      <p>
        Value Life Foundation (VLF) is established in Claremont, California, USA
        on January 2002 as a nonprofit, public benefit corporation. It is
